...
> **Tecnologia para ajudar pessoas afetadas por desastres naturais.**
...
* 📍 Identificar e apresentar pontos de risco;
* 🗺️ Trabalhar com informações de localização;
* 🚨 Apresentar possíveis alertas relacionados a desastres;
...
# 🏢 Sobre a Horizon Earth

A Horizon Earth nasceu da ideia de que a tecnologia pode ser utilizada para facilitar o acesso a informações importantes durante situações de risco.

### 🎯 Missão

Desenvolver uma solução tecnológica que facilite o acesso a informações sobre desastres naturais e áreas de risco, contribuindo para a conscientização e prevenção.

### 🔭 Visão

Criar uma plataforma capaz de alcançar diferentes regiões e ajudar cada vez mais pessoas a compreenderem os riscos relacionados a desastres naturais.
...
Seguiremos a estrutura recomendada no guia da disciplina para manter o projeto organizado e facilitar o trabalho da equipe.
